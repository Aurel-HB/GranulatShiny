...
La PERMANOVA regarde s'il existe une différence significative dans la variabilité des groupes définis par les modalités des facteurs qualitatifs. Pour évaluer cela, la technique construit une matrice de distance entre les éléments, répertoriant toutes les distances entre chaque paire d'éléments. Ensuite, elle calcule la somme des carrés des distances inter-groupe et intra-groupe.
