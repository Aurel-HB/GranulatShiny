...
Cette onglet permet de visualiser graphiquement les effets des variables explicatives sur la variable expliquée.
D'abord vous devez choisir les deux prédicteurs à représenter.<br>
```{r, echo=FALSE, warning=FALSE}
      #choix du terme
      box(
        title = "Predictor",
...
```
Si vous avez plusieurs covariables vous devez les fixer afin de pouvoir visualiser le graphique. Attention si vous avez réalisé un modèle de type PERMANOVA cette section n'est pas sollicité et la fenêtre graphique sera blanche. <br>
