...
#' 
#' Dans le acs des glm besoin de modifier la formule et la loi directement dans l'objet de sortie des glm pour que ca s'affiche correctement dans les sorties du modele
#'
