...
golem::fill_desc(
  ...
  author_first_name = "Cambreling", # Your First Name
  author_last_name = "Mathis", # Your Last Name
  author_email = "mathiscambreling@gmail.com", # Your Email
...
usethis::use_mit_license( "Cambreling Mathis" )  # You can set another license here
