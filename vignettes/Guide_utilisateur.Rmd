...
<br>Avant de commencer, notez que vous rencontrerez différents boutons dans l'application. <br>Les boutons sans icône vous permettent de passer d'un onglet à un autre.
...
Dans l'onglet des tableaux, il y a un tableau de données à droite et une partie interactive à gauche. Vous pouvez changer l'affichage du tableau de données à l'aide de la flèche située sous le message "quel tableau afficher" (1). Il est possible de télécharger (2) l'affichage du tableau de données et le paramétrage utilisé dans l'onglet des données de charge. Il faut ensuite choisir une variable expliquée sur laquelle effectuer l'analyse univariée(3). Néanmoins vous pouvez décidez de conduire une analyse multivariée ou de passer directement à l'analyse univariée.
...
La partie verte (1) est composée d'un tableau qui résume la variable expliquée et d'un simple histogramme pour voir la distribution de la variable. <br>

La partie du diagramme d'interaction (2) permet de voir l'interaction entre la zone d'impact/non-impact et les autres covariables telles que la saison, l'année, la station et l'enquête.<br>
